...
public class JobSeekerSaveController {
    ...
    public String save(@PathVariable("id") int id, JobSeekerSave jobSeekerSave) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            // **IMPORTANT:** Ensure that the JobSeekerSave object is treated as new.
            // If your form accidentally submits an ID (or version) then Hibernate may attempt an update.
            // Setting the ID to null ensures an insert.
